    ...
    <body>
        ...
        <form method="POST" action="{{ route('user.update', $data->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nameuser" class="form-control" id="nameUser" value="{{ $data->name }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="emailuser" class="form-control" id="emailUser" value="{{ $data->email }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="passworduser" class="form-control" id="passwordUser"
                    value="{{ $data->password }}" aria-describedby="nameHelp" placeholder="Enter Your password">
                <small id="nameHelp" class="form-text text-muted">Please Write Down Your Data Here.</small>
            </div>
